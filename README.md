...
<ul>
  ...
  <li><b>Geo Ai :</b> <i>I am fascinated by the potential of AI to revolutionize the way we understand and interact with spatial data. I have worked on projects that combine geospatial data with Deep Learning to address some real-world problems.</i></li>
...
- 🧠 And I’m currently learning some topics related to programming, such as SQL, JS and Ai Agents, as well as subjects in artificial intelligence like LLM and MLOps, to enhance my skills and become a proficient **GeoAi specialist***.
---
